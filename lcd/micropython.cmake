...
set(set CONFIG_LCD_DRIVER_ILI9488 1)
...
set(COMMON_HAL_SRC ${HAL_DIR}/common/softspi.c)
...
set(GC9A01_DRIVER_SRC ${DRIVER_DIR}/gc9a01/gc9a01.c)
set(GC9A01_DRIVER_INC ${DRIVER_DIR}/gc9a01)
...
LIST(APPEND SRC ${GC9A01_DRIVER_SRC})
...
LIST(APPEND INC ${GC9A01_DRIVER_INC})
